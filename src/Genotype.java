/**
 * A Genotype that uses binary strings.
 * The genotype stores two numbers.
 * @author Rob Impey
 */
...
public class Genotype 
{
    ...
    // ------------
    /**
     * Creates a new Genotype using set arrays.
     * The arrays must 16 bits long 
     ...
     * The default length for the binary strings is 16 bits
     */
    public Genotype()
    {
